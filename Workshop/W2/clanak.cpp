...
int main()
{
	...
	Datum danas(11, 10, 2018);
	Korisnik autor("Edi Omerovic", "edoedo", "raditirad", Administrator);
	Komentar komentar1("Komentar", danas, v1.Add(3), autor);
	Clanak cl("Edi Clanak1", "Rijesiti zadatak", danas, v1, "Programiranje 3", autor);
	clanak.DodajKomentar(komentar1);
	autor.setLozinka("123456");
	Komentar komentar2("Ovo je moj drugi komentar za dodajKomentar", danas, v1.Add(10), autor);
